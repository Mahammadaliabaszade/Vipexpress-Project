...
namespace Vipexfinal.Migrations
{
    ...
    [Migration("20210511162131_Createparttwo")]
    partial class Createparttwo
    {
            ...
            modelBuilder.Entity("Vipexfinal.Models.Sorgu", b =>
                {
                    ...
                    b.HasIndex("SorguTypeId")
                        .IsUnique();

                    b.ToTable("Sorgu");
                });

            modelBuilder.Entity("Vipexfinal.Models.SorguType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vipexfinal.Models.Sorgu", b =>
                {
                    ...
                    b.HasOne("Vipexfinal.Models.SorguType", "SorguType")
                        .WithOne("Sorgu")
                        .HasForeignKey("Vipexfinal.Models.Sorgu", "SorguTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
